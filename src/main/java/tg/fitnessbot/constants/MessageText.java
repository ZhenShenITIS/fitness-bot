...
public enum MessageText {
    ...
    SUCCESS_EDIT_GENDER("Ваш пол успешно обновлен!"),
    WRONG_WEIGHT("Неправильно введён вес!"),
    REQUEST_WEIGHT("Введите ваш вес:"),
    WRONG_PHOTO("Неправильно введены данные. Требуется фотография"),
    REQUEST_PHOTO("Пришлите фото"),
    WRONG_BIRTHDAY("Неправильно введен возраст!\nТребуется целое число от 0 до 100!"),
    REQUEST_BIRTHDAY("Введите вашу возраст:\n\nПодсказка: если вы волнуетесь о сохранности ваших персональных данных, можете ввести примерный возраст +- 3 года\n\nЭти данные нужны для правильного подсчета каллорий на тренировках"),
    WRONG_LIFE_ACTIVITY("Неправильно введена активность!\nТребуется число от 1 до 5"),
    REQUEST_LIFE_ACTIVITY("Введите вашу активность:\n\n1) Минимальная (сидячий образ жизни)\n" +
            "2) Лёгкая (1-3 тренировки в неделю)\n" +
            "3) Средняя (3-5 тренировок)\n" +
            "4) Высокая (6-7 тренировок)\n" +
            "5) Очень высокая (постоянная физическая нагрузка)"),
    ...
    PROFILE("Вот твои данные: \n\n" +
            ...
            "Активность: %s\n\n" +
            "Хочешь их изменить?\n\n" +
            "Твоя суточная норма потребления калорий: %s"),
    ...
    SUCCESS_PAYMENT("Успешная покупка!")
